...
To test, install `dist/MacWindowButtons-1.3.dmg`, click the menu bar icon, select Authorize Now, and enable MacWindowButtons in System Settings → Privacy & Security → Accessibility. The same control center changes button size and exits the app.
